        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="row">
                    ...
                    <div class="col-6">
                        <button class="btn btn-info w-100" @click="Save()">Actualizar</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        async Save() { //Hace que se guarden los datos 
            ...
            try {
                ...
                if (result.isConfirmed) {
                    const res = await this.$api.$put(this.apiUrl+"/"+this.model.id, this.model); // this.apiUrl+"/"+this.model.id, this.model indica que tiene que acceder al modelo y toma el id de lo que se vaya a actualizar
                    this.$swal.fire('Actualizado con éxito!', '', 'success');
                    this.$router.back();
