                            ...
                            <div class="col-12 py-2"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-6 mb-4" v-for="m in  articulosCategoria">
                                        <!-- Componente articuloVenta en carpeta pos-->
    ...
    methods: {
        ...
        async Datos() {
            ...
            try {
                ...
                await Promise.all([this.GET_DATA('marcas'), this.GET_DATA('categorias'), this.GET_DATA('inventarios')]).then((v) => {
                    ...
                    this.articulos = v[2] //obtiene el registro de inventarios se refiere a la lista de datos
                });
            }
            catch (e) {
        ...
        AddCarrito(articulo) {
            ...
            if (buscarRegistro.length > 0) {
                ...
                //valida que solo se pueda vender la cantidad de stock disponible
                ...
                const item = {
                    ...
                    precio: articulo.venta //captura el precio de venta
                }
        ...
        async Save() { //Hace que se guarden los datos 
            ...
            if (this.carrito.length === 0) {
                this.$swal.fire('Debe agregar artículos para realizar la venta', '', 'error');
                this.load = false;
                return; // Salir del if si hay artículos
            }
            try {
                const operacion = {
                ...
                if (result.isConfirmed) {
                    ...
                    this.$swal.fire('Venta realizada con éxito', '', 'success');
                    //console.log(res);
                    self.Clean()
                    self.load = true
                    await self.Datos();
